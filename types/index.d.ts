 ...
 */
export declare function useFormAtomErrors<Fields extends FormAtomFields>(formAtom: FormAtom<Fields>, scope?: Scope): FormAtomErrors<Fields> extends infer T ? T extends FormAtomErrors<Fields> ? T extends Promise<unknown> ? unknown : T : never : never;
/**
 ...
 */
export declare function useFormAtomValues<Fields extends FormAtomFields>(formAtom: FormAtom<Fields>, scope?: Scope): FormAtomValues<Fields> extends infer T ? T extends FormAtomValues<Fields> ? T extends Promise<unknown> ? unknown : T : never : never;
/**
 ...
 */
export declare function useFormAtomSubmit<Fields extends FormAtomFields>(formAtom: FormAtom<Fields>, scope?: Scope): (values: (values: FormAtomValues<Fields>) => void | Promise<void>) => (e?: React.FormEvent<HTMLFormElement>) => void;
/**
 ...
 */
export declare function useFieldAtomProps<Value>(fieldAtom: FieldAtom<Value>, scope?: Scope): FieldAtomProps<Value>;
/**
 ...
 */
export declare function useFieldAtomValue<Value>(fieldAtom: FieldAtom<Value>, scope?: Scope): Value extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? V extends Promise<infer V> ? any : V : V : V : V : V : V : V : V : V : V : Value;
/**
 ...
 * @returns The errors of the field atom.
 */
export declare function useFieldAtom<Value>(fieldAtom: FieldAtom<Value>, scope?: Scope): UseFieldAtom<Value>;
/**
 ...
 */
export declare type Validate<Value> = FieldAtomConfig<Value>["validate"];
/**
 * A utility type for easily typing validate function configurations
 */
export declare type ValidateConfig<Value> = Parameters<Exclude<FieldAtomConfig<Value>["validate"], undefined>>[0];
/**
